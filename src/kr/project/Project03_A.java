...
public class Project03_A {
	...
	public static void main(String[] args) {
		...
		try(FileInputStream fis = new FileInputStream(fileName)) {
			...
			HSSFWorkbook workbook = new HSSFWorkbook(fis);	//bookList파일을 메모리에 적재시킴
			HSSFSheet sheet = workbook.getSheetAt(0);	//메모리에 sheet 적재
	...
	public static void showExcelDate(List<ExcelVO> data) {
